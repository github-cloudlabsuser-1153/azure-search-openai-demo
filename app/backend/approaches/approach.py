...
class Document:
    ...
    def serialize_for_results(self) -> dict[str, Any]:
        """
        Serializes the document object into a dictionary format for results.
...
class ThoughtStep:
    """
    Represents a thought step with its properties.

    Attributes:
        title (str): The title of the thought step.
        description (Optional[Any]): The description of the thought step.
        props (Optional[dict[str, Any]]): The properties of the thought step.
    """
...
class Approach(ABC):
    ...
    async def search(
        ...
        Args:
            ...
            filter (Optional[str]): The filter expression.
